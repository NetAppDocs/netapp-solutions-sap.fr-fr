...
Vous trouverez une description plus détaillée à l'adresse suivante : link:hana-sc-generic-sc-resource-config.html#sap-hana-backup-user-and-sap-hana-user-store-configuration["Configuration SnapCenter propre aux ressources pour les sauvegardes de bases de données SAP HANA"]
