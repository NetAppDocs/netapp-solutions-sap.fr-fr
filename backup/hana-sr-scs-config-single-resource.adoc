...
....
Vous trouverez plus d'informations sur les options de déploiement du plug-in SAP HANA et la configuration du magasin d'utilisateurs dans link:hana-sc-generic-scope.html["SAP HANA : sauvegarde et restauration avec SnapCenter"^].
