...
link:hana-sc-generic-scope.html["Sauvegarde et restauration SAP HANA avec SnapCenter"]

link:hana-sr-scs-system-replication-overview.html["Réplication système SAP HANA : sauvegarde et restauration avec SnapCenter"]
