...
link:amazon-fsx-backup-replication-with-snapvault_overview.html["Précédent : présentation - sauvegarde de la réplication avec SnapVault."]
...
sapcc-hana-svm:PFX_data_mnt00001
            XDP  sapcc-backup-target-zone5:PFX_data_mnt00001
                              Snapmirrored
                                      Idle           -         true    -
....
link:amazon-fsx-add-a-backup-svm-to-snapcenter.html["Next : ajout d'un SVM de sauvegarde à SnapCenter."]
