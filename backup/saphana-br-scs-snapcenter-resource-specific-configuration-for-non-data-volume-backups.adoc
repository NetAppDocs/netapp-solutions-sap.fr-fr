...
link:saphana-br-scs-snapcenter-resource-specific-configuration-for-sap-hana-database-backups.html["Précédent : configuration spécifique aux ressources SnapCenter pour les sauvegardes de bases de données SAP HANA."]
...
link:saphana-br-scs-database-backups.html["Suivant : sauvegardes de bases de données."]
