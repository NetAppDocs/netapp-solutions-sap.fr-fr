...
link:saphana-br-scs-database-backups.html["Précédent : sauvegardes de bases de données."]
...
....
link:saphana-br-scs-restore-and-recovery.html["Suivant : restauration et récupération."]
