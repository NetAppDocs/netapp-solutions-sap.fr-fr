...
La corruption logique peut être causée par des erreurs logicielles, des erreurs humaines ou un sabotage. Malheureusement, la corruption logique ne peut souvent pas être résolue avec les solutions standard de haute disponibilité et de reprise après sinistre. Par conséquent, selon la couche, l'application, le système de fichiers ou le stockage où la corruption logique s'est produite, les exigences maximales d'interruption et de perte de données ne peuvent parfois pas être respectées.
...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf["Reprise après incident de SAP HANA avec la réplication du stockage"]

link:../backup/hana-dr-anf-data-protection-overview.html["Reprise d'activité SAP HANA avec Azure NetApp Files"]
