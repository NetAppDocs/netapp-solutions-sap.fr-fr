...
image::saphana-fas-nfs_image10.png[image nfs saphana FAS 10]
...
image::saphana-fas-nfs_image11.png[image nfs saphana FAS 11]
...
image::saphana-fas-nfs_image12.png[image nfs saphana FAS 12]
