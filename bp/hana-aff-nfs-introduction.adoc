...
[role="lead"]
La famille de produits NetApp AFF A-Series a été certifiée pour une utilisation avec SAP HANA dans des projets d'intégration de centres de données sur mesure (TDI).  Ce guide fournit les meilleures pratiques pour SAP HANA sur cette plateforme pour NFS.
...
* https://help.sap.com/docs/SAP_HANA_PLATFORM/eb3777d5495d46c5b2fa773206bbfb46/0b15a92d554c4941a452c9ca127f8c70.html["Intégration personnalisée des centres de données SAP HANA"^]
