...
NOTE: NetApp ASA systèmes ne prennent pas en charge NFS comme protocole. NetApp recommande d'utiliser un système AFF ou FAS supplémentaire pour les `/hana/shared` et `/lss/shared` systèmes de fichiers.
