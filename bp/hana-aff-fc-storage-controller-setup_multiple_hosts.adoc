...
NOTE: Les systèmes NetApp ASA ne prennent pas en charge NFS en tant que protocole.  NetApp recommande d'utiliser un système AFF ou FAS supplémentaire pour le `/hana/shared` système de fichiers.
