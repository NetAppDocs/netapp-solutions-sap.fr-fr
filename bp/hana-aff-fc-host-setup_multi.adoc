...
Pour créer les répertoires de points de montage requis, définissez les autorisations et créez des points de montage sur tous les hôtes de travail et de secours.
