...
. Créez des groupes initiateurs (igroups) avec des noms WWN (WWN) des serveurs HANA, comme décrit dans la section link:saphana_FAS_fc_Storage_Controller_setup.html#initiator-groups <<Groupes d'initiateurs>>.
