...
Le tableau suivant présente la configuration LUN d'un système SAP HANA multi-hôtes 2+1.

|===
| Objectif | LUN | Volume logique LVM 


| Hôte de données 1 | FC5_data_mnt00001_1 FC5_data_mnt00001_2 | FC5_data_mnt00001-vol 


| Hôte de données 2 | FC5_data_mnt00002_1 FC5_data_mnt00002_2 | FC5_data_mnt00002-vol 


| Hôte de journalisation 1 | FC5_log_mnt00001_1 FC5_log_mnt00001_2 | FC5_log_mnt00001-vol 


| Hôte de journalisation 2 | FC5_log_mnt00002_1 FC5_log_mnt00002_2 | FC5_log_mnt00002-vol 
|===

NOTE: Le volume /hana/shared doit être accessible par tous les hôtes SAP HANA et est donc généralement exporté via NFS. Comme les systèmes NetApp ASA ne prennent pas en charge NFS comme protocole, NetApp recommande d'utiliser un système AFF ou FAS supplémentaire pour le système de fichiers /hana/shared.
...
NOTE: Si le service SAP Local Secure Store (LSS) est utilisé, le  `/lss/shared/SID` répertoire doit être accessible depuis tous les hôtes et est donc généralement exporté en utilisant NFS. Comme les systèmes NetApp ASA ne prennent pas en charge NFS comme protocole, NetApp recommande d'utiliser un système AFF ou FAS supplémentaire pour le système de fichiers /lss/shared.
...
. Fournissez les informations requises :
+
.. le nom des LUN de journal à combiner avec LVM, par exemple `FC5_log_mnt00001`
.. la quantité de LUN à combiner avec LVM, par exemple 2
