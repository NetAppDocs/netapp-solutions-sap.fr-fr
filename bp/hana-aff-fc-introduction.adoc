...
La famille de produits NetApp AFF/ ASA A-Series a été certifiée pour une utilisation avec SAP HANA dans des projets d'intégration de centres de données sur mesure (TDI).
