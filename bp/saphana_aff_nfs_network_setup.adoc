...
image::saphana_aff_nfs_image10.png[image nfs saphana AFF 10]
...
image::saphana_aff_nfs_image11.png[image nfs saphana AFF 11]
...
image::saphana_aff_nfs_image12.png[image nfs saphana AFF 12]
