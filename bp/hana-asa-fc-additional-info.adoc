...
* link:../backup/hana-sc-vmware-smas-scope.html["Protection des données SAP HANA et haute disponibilité avec SnapCenter, la synchronisation active SnapMirror et le cluster de stockage VMware Metro"^]
