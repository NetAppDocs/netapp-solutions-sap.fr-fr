...
link:saphana_aff_nfs_sap_hana_data_volume_size.html["Précédent : taille du volume de données SAP HANA."]
...
link:saphana_aff_nfs_adding_additional_data_volume_partitions.html["Ensuite, ajout de partitions de volume de données supplémentaires."]
