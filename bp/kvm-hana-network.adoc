...
[role="lead"]
Configurez les interfaces réseau SR-IOV sur SUSE KVM pour SAP HANA. Créez des fonctions virtuelles (VF), affectez-les à des machines virtuelles (VM) et configurez des connexions réseau redondantes pour des performances et un accès au stockage optimaux. La mise en réseau en mode pont est également prise en charge.
