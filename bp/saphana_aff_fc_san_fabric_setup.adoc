...
link:saphana_aff_fc_infrastructure_setup_and_configuration_overview.html["Précédent : installation et configuration de l'infrastructure."]
...
link:saphana_aff_fc_time_synchronization.html["Suivant : synchronisation de l'heure."]
