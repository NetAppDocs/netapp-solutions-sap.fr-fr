...
Pour plus d'informations sur la solution de sauvegarde et de restauration SAP HANA utilisant SnapCenter, consultez link:../backup/hana-sc-generic-scope.html["SAP HANA : sauvegarde et restauration avec SnapCenter"^].
