...
---
= Tr-4384 : SAP HANA sur les systèmes NetApp FAS avec le protocole Fiber Channel
:allow-uri-read: 
...
image:saphana_fas_fc_image1.png["Erreur : image graphique manquante"]
...
link:saphana_fas_fc_architecture.html["Ensuite : l'architecture."]
