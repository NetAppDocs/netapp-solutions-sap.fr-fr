...
Un disque SSD NVMe (données) prend en charge jusqu'à 5 hôtes SAP HANA.
...
image:saphana_aff_fc_image8.jpg["Figure montrant la boîte de dialogue entrée/sortie ou représentant le contenu écrit"]
